...
const { CODEX_DIR, CLAUDE_CODE_DIR, OMP_DIR, DSH_DIR, GEMINI_DIR } = require('./config');
...
const OTLP_PLATFORMS = {
  ...
  gemini: { defaultDir: () => GEMINI_DIR, find: findGeminiSessionFile, parse: parseGeminiSessionFile },
};
